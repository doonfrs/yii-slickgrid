(function ($) {
  ...
  function RemoteModel() {
    ...
    function ensureData(from, to) {
      ...
      var url = slickGridDataSource + "/ajax/" + this.gridId + "/query/" + searchstr + "/page/" + fromPage + "/count/" + (((toPage - fromPage) * PAGESIZE) + PAGESIZE);

      if (sortcol) {
          url += ("/" + sortcol + "_sort/" + sortcol + ((sortdir > 0) ? ".asc" : ".desc"));
      }
